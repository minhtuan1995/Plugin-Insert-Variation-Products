            ...
            <div class="col-lg-12">
               <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                     <div class="row">
                        <form role="form" method="post" action="admin.php?page=tool-options">
                           ...
                           <button type="submit" class="btn btn-danger" style="margin-left: 20px;">Clear Session</button>
                           ...
                           <p class="help-block" style="margin-left: 20px;">Clear Session to get another oauth2 if you get errors.</p>
                        </form>
                     </div>
                  </div>
               </div>
